...
from PyQt5.QtWidgets import QApplication, QLabel, QLineEdit, QPushButton, QVBoxLayout, QWidget, QSlider, QDialog, \
    QHBoxLayout, QCheckBox, QMessageBox, QProgressBar, QComboBox, QFileDialog, QMainWindow, QListWidget
...
class CallWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Call with Modem")
        self.setGeometry(100, 100, 800, 600)

        self.modem_label = QLabel("Connected Modems:")
        self.modem_list = QListWidget()

        self.refresh_button = QPushButton("Refresh")
        self.refresh_button.clicked.connect(self.refresh_modems)

        self.call_button = QPushButton("Call")
        self.call_button.clicked.connect(self.make_call)

        layout = QVBoxLayout()
        layout.addWidget(self.modem_label)
        layout.addWidget(self.modem_list)
    ...
    def refresh_modems(self):
        # Code to refresh the list of connected modems
        pass

    def make_call(self):
        selected_modem = self.modem_list.currentItem().text()
        # Code to make a call using the selected modem
        pass
